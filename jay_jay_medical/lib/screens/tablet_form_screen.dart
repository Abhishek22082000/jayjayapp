...
class _TabletFormScreenState extends ConsumerState<TabletFormScreen> {
  ...
  void _hydrateFromExisting() {
    ...
    switch (t.quantityUnit) {
      case 'strip':
        _quantityUnit = QuantityUnit.strip;
        break;
      case 'packet':
        _quantityUnit = QuantityUnit.packet;
        break;
      default:
        _quantityUnit = QuantityUnit.tablet;
    }
  ...
  Future<void> _onSave() async {
    ...
    try {
      ...
      final Tablet t = Tablet(
        ...
        quantityUnit: _quantityUnit.name,
